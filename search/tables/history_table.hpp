...
TuningOption pawn_weight("pawn_weight", 176, 0, 600);
TuningOption nonpawn_weight("nonpawn_weight", 166, 0, 600);
TuningOption threat_weight("threat_weight", 103, 0, 600);
TuningOption major_weight("major_weight", 77, 0, 600);
TuningOption minor_weight("minor_weight", 181, 0, 600);
TuningOption center_weight("center_weight", 113, 0, 600);
