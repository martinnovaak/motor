...
public:
    ...
    void make_null_move()
    {
        ...
        state->adeh_key = old_info->adeh_key;
    ...
    [[nodiscard]] std::uint64_t get_adeh_key() const {
        return state->adeh_key.get_key();
    }
    ...
    void make_state(Piece captured_piece, chess_move played_move) {
        ...
        state->adeh_key = old_state->adeh_key;
