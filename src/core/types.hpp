...
enum Piece : uint8_t { Pawn, Knight, Bishop, Rook, Queen, King, Null_Piece };
...
constexpr static std::uint64_t files[]{0x101010101010101ull,  0x202020202020202ull,  0x404040404040404ull,
                                       0x808080808080808ull,  0x1010101010101010ull, 0x2020202020202020ull,
                                       0x4040404040404040ull, 0x8080808080808080ull};

constexpr static std::uint64_t ranks[]{0x00000000000000ffull, 0x000000000000ff00ull, 0x0000000000ff0000ull,
